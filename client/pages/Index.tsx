    ...
    <div className="min-h-screen bg-white max-w-[430px] mx-auto relative">
      ...
      <div className="flex justify-between items-center px-4 py-2">
        <div className="flex items-center gap-3">
          ...
          />
          <div>
            <div className="text-xs text-gray-500">Welcome Collector,</div>
        ...
        <div className="flex items-center gap-2 bg-gray-bg px-3 py-2 rounded-full">
          ...
          <span className="text-xs text-black">Connect Wallet</span>
        </div>
      </div>
          ...
          <div key={recycler.id}>
            <div className="flex items-center justify-between py-3">
              ...
              <Button
                ...
                className="bg-green-primary text-white hover:bg-green-primary/90 px-4 py-1 text-xs h-7 rounded-full"
              >
                View
              </Button>
            </div>
